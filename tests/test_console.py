...
def mock_wikipedia_random_page(mocker: MockFixture) -> Mock:
    ...
    return mocker.patch("wikir.wikipedia.random_page")
...
def test_main_uses_en_wikipedia_org(runner: CliRunner, mock_requests_get: Mock) -> None:
    """It uses then English Wikipedia by default."""
    runner.invoke(console.main)
...
def test_main_fails_on_request_Error(
    ...
    """It exits with a status code of one if the request fails."""
